...
function Card({ card, onCardClick, onCardLike, onDeleteClick }) {
    ...
    const cardLikeButtonClass = `card__info-button ${isLiked && "card__info-button_active"}`;
       ...
       <div className="card">
            ...
            <div className="card__info">
                ...
                <div className="card__info-container">
                    <button className={cardLikeButtonClass} onClick={handleCardLike} type="button"></button>
